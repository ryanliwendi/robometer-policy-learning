"""VENDORED VERBATIM from Diff-DAgger (Lee, Kang & Kuo, ICRA 2025; arXiv:2410.14868).

Source: https://github.com/sean1295/DiffDAgger -- diffdagger/util/cdf.py
Unmodified. Supplies the alpha-quantile of the training diffusion-loss distribution.
"""
